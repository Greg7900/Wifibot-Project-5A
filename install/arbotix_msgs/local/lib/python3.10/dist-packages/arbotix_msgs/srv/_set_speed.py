...
class Metaclass_SetSpeed(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from arbotix_msgs.srv import _set_speed
...
class SetSpeed(metaclass=Metaclass_SetSpeed):
    from arbotix_msgs.srv._set_speed import SetSpeed_Request as Request
    from arbotix_msgs.srv._set_speed import SetSpeed_Response as Response
