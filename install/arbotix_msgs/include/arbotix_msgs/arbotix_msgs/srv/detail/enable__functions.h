...
#ifndef ARBOTIX_MSGS__SRV__DETAIL__ENABLE__FUNCTIONS_H_
#define ARBOTIX_MSGS__SRV__DETAIL__ENABLE__FUNCTIONS_H_
 ...
 * calls
 * arbotix_msgs__srv__Enable_Request__init().
...
/**
 * It calls
 * arbotix_msgs__srv__Enable_Request__fini()
 ...
 * arbotix_msgs__srv__Enable_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * arbotix_msgs__srv__Enable_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * arbotix_msgs__srv__Enable_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_arbotix_msgs
...
/**
 * It calls
 * arbotix_msgs__srv__Enable_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_arbotix_msgs
...
/**
 * It allocates the memory for the array and calls
 * arbotix_msgs__srv__Enable_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_arbotix_msgs
...
/**
 * It calls
 * arbotix_msgs__srv__Enable_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ARBOTIX_MSGS__SRV__DETAIL__ENABLE__FUNCTIONS_H_
