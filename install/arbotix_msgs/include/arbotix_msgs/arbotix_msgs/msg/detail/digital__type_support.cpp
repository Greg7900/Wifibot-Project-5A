...
{
  new (message_memory) arbotix_msgs::msg::Digital(_init);
}

void Digital_fini_function(void * message_memory)
{
  auto typed_message = static_cast<arbotix_msgs::msg::Digital *>(message_memory);
  typed_message->~Digital();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Digital_message_member_array[3] = {
  {
    "header",  // name
    ...
    offsetof(arbotix_msgs::msg::Digital, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(arbotix_msgs::msg::Digital, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(arbotix_msgs::msg::Digital, direction),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Digital_message_members = {
  "arbotix_msgs::msg",  // message namespace
  "Digital",  // message name
  3,  // number of fields
  sizeof(arbotix_msgs::msg::Digital),
...
{
  return &::arbotix_msgs::msg::rosidl_typesupport_introspection_cpp::Digital_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arbotix_msgs, msg, Digital)() {
  return &::arbotix_msgs::msg::rosidl_typesupport_introspection_cpp::Digital_message_type_support_handle;
}
