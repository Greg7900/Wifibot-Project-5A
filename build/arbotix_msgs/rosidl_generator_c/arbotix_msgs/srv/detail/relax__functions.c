...
arbotix_msgs__srv__Relax_Request__create()
{
  ...
  arbotix_msgs__srv__Relax_Request * msg = (arbotix_msgs__srv__Relax_Request *)allocator.allocate(sizeof(arbotix_msgs__srv__Relax_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(arbotix_msgs__srv__Relax_Request));
  bool success = arbotix_msgs__srv__Relax_Request__init(msg);
  if (!success) {
...
arbotix_msgs__srv__Relax_Request__destroy(arbotix_msgs__srv__Relax_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    arbotix_msgs__srv__Relax_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
arbotix_msgs__srv__Relax_Request__Sequence__init(arbotix_msgs__srv__Relax_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arbotix_msgs__srv__Relax_Request * data = NULL;

  if (size) {
    data = (arbotix_msgs__srv__Relax_Request *)allocator.zero_allocate(size, sizeof(arbotix_msgs__srv__Relax_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = arbotix_msgs__srv__Relax_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        arbotix_msgs__srv__Relax_Request__fini(&data[i - 1]);
      }
...
arbotix_msgs__srv__Relax_Request__Sequence__fini(arbotix_msgs__srv__Relax_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      arbotix_msgs__srv__Relax_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arbotix_msgs__srv__Relax_Request__Sequence * array = (arbotix_msgs__srv__Relax_Request__Sequence *)allocator.allocate(sizeof(arbotix_msgs__srv__Relax_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = arbotix_msgs__srv__Relax_Request__Sequence__init(array, size);
  if (!success) {
...
arbotix_msgs__srv__Relax_Request__Sequence__destroy(arbotix_msgs__srv__Relax_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    arbotix_msgs__srv__Relax_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
arbotix_msgs__srv__Relax_Request__Sequence__are_equal(const arbotix_msgs__srv__Relax_Request__Sequence * lhs, const arbotix_msgs__srv__Relax_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!arbotix_msgs__srv__Relax_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  arbotix_msgs__srv__Relax_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(arbotix_msgs__srv__Relax_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    arbotix_msgs__srv__Relax_Request * data =
      (arbotix_msgs__srv__Relax_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!arbotix_msgs__srv__Relax_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          arbotix_msgs__srv__Relax_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!arbotix_msgs__srv__Relax_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arbotix_msgs__srv__Relax_Response * msg = (arbotix_msgs__srv__Relax_Response *)allocator.allocate(sizeof(arbotix_msgs__srv__Relax_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(arbotix_msgs__srv__Relax_Response));
  bool success = arbotix_msgs__srv__Relax_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
arbotix_msgs__srv__Relax_Response__destroy(arbotix_msgs__srv__Relax_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    arbotix_msgs__srv__Relax_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
arbotix_msgs__srv__Relax_Response__Sequence__init(arbotix_msgs__srv__Relax_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arbotix_msgs__srv__Relax_Response * data = NULL;

  if (size) {
    data = (arbotix_msgs__srv__Relax_Response *)allocator.zero_allocate(size, sizeof(arbotix_msgs__srv__Relax_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = arbotix_msgs__srv__Relax_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        arbotix_msgs__srv__Relax_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
arbotix_msgs__srv__Relax_Response__Sequence__fini(arbotix_msgs__srv__Relax_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      arbotix_msgs__srv__Relax_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arbotix_msgs__srv__Relax_Response__Sequence * array = (arbotix_msgs__srv__Relax_Response__Sequence *)allocator.allocate(sizeof(arbotix_msgs__srv__Relax_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = arbotix_msgs__srv__Relax_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
arbotix_msgs__srv__Relax_Response__Sequence__destroy(arbotix_msgs__srv__Relax_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    arbotix_msgs__srv__Relax_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
arbotix_msgs__srv__Relax_Response__Sequence__are_equal(const arbotix_msgs__srv__Relax_Response__Sequence * lhs, const arbotix_msgs__srv__Relax_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!arbotix_msgs__srv__Relax_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  arbotix_msgs__srv__Relax_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(arbotix_msgs__srv__Relax_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    arbotix_msgs__srv__Relax_Response * data =
      (arbotix_msgs__srv__Relax_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!arbotix_msgs__srv__Relax_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          arbotix_msgs__srv__Relax_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!arbotix_msgs__srv__Relax_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
