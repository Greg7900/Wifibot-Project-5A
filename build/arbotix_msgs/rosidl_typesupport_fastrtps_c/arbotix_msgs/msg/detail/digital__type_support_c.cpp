...
#include "arbotix_msgs/msg/detail/digital__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_arbotix_msgs
...
using _Digital__ros_msg_type = arbotix_msgs__msg__Digital;
...
size_t get_serialized_size_arbotix_msgs__msg__Digital(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Digital__ros_msg_type * ros_message = static_cast<const _Digital__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Digital__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arbotix_msgs__msg__Digital(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arbotix_msgs
size_t max_serialized_size_arbotix_msgs__msg__Digital(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Digital__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arbotix_msgs__msg__Digital(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arbotix_msgs, msg, Digital)() {
