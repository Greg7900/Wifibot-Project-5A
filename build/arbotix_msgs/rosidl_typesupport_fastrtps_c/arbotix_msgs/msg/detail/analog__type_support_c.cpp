...
#include "arbotix_msgs/msg/detail/analog__rosidl_typesupport_fastrtps_c.h"
...
using _Analog__ros_msg_type = arbotix_msgs__msg__Analog;
...
size_t get_serialized_size_arbotix_msgs__msg__Analog(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Analog__ros_msg_type * ros_message = static_cast<const _Analog__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Analog__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arbotix_msgs__msg__Analog(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arbotix_msgs
size_t max_serialized_size_arbotix_msgs__msg__Analog(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Analog__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arbotix_msgs__msg__Analog(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arbotix_msgs, msg, Analog)() {
