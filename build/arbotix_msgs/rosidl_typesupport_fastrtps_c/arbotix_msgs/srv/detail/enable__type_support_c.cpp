...
#include "arbotix_msgs/srv/detail/enable__rosidl_typesupport_fastrtps_c.h"
...
using _Enable_Request__ros_msg_type = arbotix_msgs__srv__Enable_Request;
...
size_t get_serialized_size_arbotix_msgs__srv__Enable_Request(
  const void * untyped_ros_message,
...
static uint32_t _Enable_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arbotix_msgs__srv__Enable_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arbotix_msgs
size_t max_serialized_size_arbotix_msgs__srv__Enable_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Enable_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arbotix_msgs__srv__Enable_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arbotix_msgs, srv, Enable_Request)() {
...
using _Enable_Response__ros_msg_type = arbotix_msgs__srv__Enable_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arbotix_msgs
size_t get_serialized_size_arbotix_msgs__srv__Enable_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Enable_Response__ros_msg_type * ros_message = static_cast<const _Enable_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_arbotix_msgs__srv__Enable_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arbotix_msgs
size_t max_serialized_size_arbotix_msgs__srv__Enable_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Enable_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arbotix_msgs__srv__Enable_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arbotix_msgs, srv, Enable_Response)() {
...
// already included above
// #include "arbotix_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "arbotix_msgs/srv/enable.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arbotix_msgs, srv, Enable)() {
