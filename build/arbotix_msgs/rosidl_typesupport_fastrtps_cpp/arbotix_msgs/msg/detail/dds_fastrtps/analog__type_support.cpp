...
#include "arbotix_msgs/msg/detail/analog__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const arbotix_msgs::msg::Analog & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arbotix_msgs::msg::Analog & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const arbotix_msgs::msg::Analog *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arbotix_msgs::msg::Analog *>(
    untyped_ros_message);
...
{
  return &arbotix_msgs::msg::typesupport_fastrtps_cpp::_Analog__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arbotix_msgs, msg, Analog)() {
  return &arbotix_msgs::msg::typesupport_fastrtps_cpp::_Analog__handle;
}
