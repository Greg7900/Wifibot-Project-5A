...
bool arbotix_msgs__msg__digital__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arbotix_msgs.msg._digital.Digital", full_classname_dest, 33) == 0);
  }
  arbotix_msgs__msg__Digital * ros_message = _ros_message;
  {  // header
...
PyObject * arbotix_msgs__msg__digital__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("arbotix_msgs.msg._digital");
